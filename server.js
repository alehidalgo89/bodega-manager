...
<body>
    ...
    <div class="container">
        ...
        <div id="movimientos" class="tab-content active">
            ...
            <div id="formMov" style="display:none;" class="section">
                ...
                <div id="ubicacionesDisponibles" style="display:none; margin:15px 0;">
                    <label>Selecciona ubicación específica a registrar:</label>
                    <div id="ubicacionesList" style="background:rgba(0,0,0,0.3); padding:10px; border-radius:3px; max-height:200px; overflow-y:auto;"></div>
                </div>
        ...
        <div id="inventario" class="tab-content">
            ...
            <div class="section">
                ...
                <button onclick="limpiarFiltros()" style="background:#999;">LIMPIAR</button>
            </div>
    ...
    <script>
            ...
            if (res.error) {
                ...
                if (encontrados.length > 1) {
                    ...
                    encontrados.forEach((v, idx) => {
                        ...
                        html += '<div style="background:rgba(76,175,80,0.2); padding:8px; margin:5px 0; border-radius:3px; cursor:pointer;" onclick="seleccionarUbicacion(' + idx + ', ' + v.id + ')">';
                        html += '<strong>' + ubic + '</strong> - ID: ' + v.id;
                        html += '</div>';
                    });
        ...
        function seleccionarUbicacion(idx, vinoId) {
            ...
            document.getElementById('ubicacionesList').innerHTML = '<strong style="color:#4CAF50;">✅ Seleccionado: ' + vinoId + '</strong>';
        ...
        async function cargarInventario() {
            ...
            if (filtrados.length === 0) {
                ...
                filtrados.forEach(r => {
                    ...
                    const colorEstado = estado === 'Disponible' ? '#4CAF50' : (estado === 'Consumido' ? '#999' : (estado === 'Vendido' ? '#999' : '#f44336'));
