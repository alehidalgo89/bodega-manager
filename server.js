...
<body>
    ...
    <div class="container">
        ...
        <div id="entrada" class="tab-content active">
            ...
            <button onclick="registrarVino()">Registrar Vino(s)</button>
        ...
        <div id="movimientos" class="tab-content">
            <h2>Registrar Movimiento de Vino</h2>
            <p style="color: #b0b0b0; margin-bottom: 20px;">🔄 Registra entrada, salida, traslado o daño de vinos</p>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="tipo-movimiento" required>
                        <option value="">-- Seleccionar --</option>
                        <option value="Entrada">📥 Entrada (Nuevo registro)</option>
                ...
                <div class="form-group">
                    <label>Código QR o ID del Vino *</label>
