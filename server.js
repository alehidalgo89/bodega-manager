...
app.get('/', (req, res) => {
    res.sendFile(__dirname + '/index.html', err => {
        if (err) {
            res.send('<!DOCTYPE html><html><head><title>Bodegas</title></head><body style="background:#08091a;color:#f5f5f5;font-family:Arial;padding:40px"><h1>Bodegas</h1><p>Cargando...</p></body></html>');
        }
    });
});
