...
<head>
    ...
    <style>
        ...
        * {
        ...
        .tab-content {
            display: none;
            background: linear-gradient(135deg, rgba(37, 37, 37, 0.5) 0%, rgba(26, 26, 26, 0.3) 100%);
            padding: 30px;
            border-radius: 12px;
            border: 1px solid var(--border-color);
        ...
        button[style*="background:#999"]:hover,
        button[style*="background: #999"]:hover {
        ...
        /* ============================================
           ...
           ============================================ */
        .section {
            background: linear-gradient(135deg, rgba(37, 37, 37, 0.3) 0%, rgba(26, 26, 26, 0.2) 100%);
            padding: 20px;
            margin: 20px 0;
            border-radius: 10px;
        ...
        table th {
            background: linear-gradient(135deg, rgba(212, 175, 55, 0.15) 0%, rgba(114, 46, 46, 0.1) 100%);
            padding: 15px;
            text-align: left;
            font-weight: 600;
            color: var(--gold-primary);
        ...
        /* ============================================
           ...
           ============================================ */
        .info {
            background: rgba(74, 159, 165, 0.1);
            padding: 15px;
            margin: 15px 0;
            border-radius: 8px;
